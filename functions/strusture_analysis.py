...
def make_masks(data):
    mask_list = [
            data['decomposition'] == defaultdict(int, {'Mo1': 63, 'W1': 1, 'Se1': 2, 'S1': 126}),
            data['decomposition'] == defaultdict(int, {'Mo1': 63, 'W1': 1, 'Se1': 1, 'S1': 126}),
            data['decomposition'] == defaultdict(int, {'Mo1': 63, 'Se1': 1, 'S1': 126}),
